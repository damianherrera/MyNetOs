...
#Region "FIELDS"
    ...
    Private mConnectionStringEncrypt As String
    ...
    Public Shared Event GetSQLConnectionString(ByRef mRetorno As String)
...
#Region "PROPERTIES"
    ...
    Public Property ConnectionString() As String
        Get
            Dim mSqlConnectionString As String = Nothing
            RaiseEvent GetSQLConnectionString(mSqlConnectionString)
            If mSqlConnectionString <> "" Then
    ...
    Public Property ConnectionStringEncrypt() As String
        Get
            Return mConnectionStringEncrypt
        End Get
        Set(ByVal value As String)
            mConnectionStringEncrypt = value
        End Set
    End Property
...
#Region "CONSTRUCTOR"
    Public Sub New(ByVal pXmlDocument As Xml.XmlDocument)
        ...
        If mProviderFactoryXmlNode.SelectSingleNode("property[@name='connection-string-encrypt']") IsNot Nothing AndAlso
            mProviderFactoryXmlNode.SelectSingleNode("property[@name='connection-string-encrypt']").FirstChild IsNot Nothing Then
            mConnectionStringEncrypt = mProviderFactoryXmlNode.SelectSingleNode("property[@name='connection-string-encrypt']").FirstChild.Value
            If mConnectionStringEncrypt = "AES256" Then
                mConnectionString = MyNetOS.Orm.Security.CryptoHelper.DecryptUrl(mConnectionString, False)
            End If
        End If
        ...
        If mProviderFactoryXmlNode.SelectSingleNode("property[@name='provider-wsurl']") IsNot Nothing AndAlso
